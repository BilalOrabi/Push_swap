...
/*   Updated: 2026/01/09 19:35:50 by borabi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

/*Range-based sorting strategies
complexty o(n*sqrt(n))
divide into ranges 
push to stack b and then push 
then back to stack a sorted
*/
#include "push_swap.h"
...
static void	push_to_b(t_data *data)
{
	...
	while (data->a->size > 0)
	{
		...
		bottom_dst = find_from_bottom (data, (pushed - range), (pushed + range));
